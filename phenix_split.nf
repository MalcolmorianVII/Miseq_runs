...
workflow {
    ...
    params.phenix_config = "/home/bkutambe/salmonella/references/2022.11.29/phenix_config.yml"
    ...
    prepareReference(read_pairs_phenix, ref)
    runSNPPipeline(read_pairs_phenix, phenix_config, ref)
    convertVCFtoFASTA(runSNPPipeline.out, phenix_config, ref)
